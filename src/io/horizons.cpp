 ...
 **************************/
bool fetchHorizonsEphemeris(const HorizonsFetchOptions& opts, const std::string& outputPath,
                            bool verbose)
{
    ...
    if (j.contains("error"))
    {
        std::cerr << "❌ HORIZONS API returned error: " << j["error"].get<std::string>() << "\n";
        return false;
    }
 ...
 ****************************************************/
bool fetchHorizonsEphemerisPOST(const HorizonsFetchOptions& opts, const std::string& outputPath,
                                bool verbose)
{
    //   const std::string url = "https://ssd-api.jpl.nasa.gov/horizons_file.api";
    //   // GET API
    const std::string url = "https://ssd.jpl.nasa.gov/api/horizons.api"; // POST API
